...
const PREFIX = "/"
const thanksWords = ["thank you", "diky", "dekuji", "thnx", "thx", "thnks", "dekuju", "спс", "спасибо", "спасибочки", "спасиб", "пасиб", "thnk", "thks"];
...
module.exports = (client, message) => {
    try {
        ...
        var found = false;
        thanksWords.forEach((word) => { if ((!(found))&&(message.content.includes(word))) client.commands['thanks'][0](client, message); });
